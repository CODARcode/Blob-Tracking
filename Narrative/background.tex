...
Various I/O and staging tools are developed for in situ visualization, such as ADIOS~\cite{LofsteadZKS09}, Damaris/Viz~\cite{DorierSPAS13}, FlexIO~\cite{ZhengZESWDNCAKPY13}, and DataSpaces~\cite{DocanPK12}, and \remark{Decaf}~\cite{}.  
